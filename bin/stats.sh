...
./bin/phoenix/q30.py "${READ_R1}" > ${STATS_DIR}/${SAMPLE_NAME}_R1_stats.txt
./bin/phoenix/q30.py "${READ_R2}" > ${STATS_DIR}/${SAMPLE_NAME}_R2_stats.txt
./bin/phoenix/create_raw_stats_output.py -n ${SAMPLE_NAME} -r1 ${STATS_DIR}/${SAMPLE_NAME}_R1_stats.txt -r2 ${STATS_DIR}/${SAMPLE_NAME}_R2_stats.txt

mv ${SAMPLE_NAME}_raw_read_counts.txt ${STATS_DIR}
